...

{
  ...
  printf 'FRONTEND_LOGIN_URL=https://hph-frontend-668900523842.asia-south1.run.app/login\n'
  printf 'LOG_DECRYPTED_PAYLOADS=false\n'
  printf 'CORS_ALLOWED_ORIGINS=https://hph-frontend-668900523842.asia-south1.run.app\n'
